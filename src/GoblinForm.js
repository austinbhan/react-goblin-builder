...
export default function GoblinForm({ submitGoblin, goblinFormName, goblinFormHP, goblinFormColor, setGoblinFormName, setGoblinFormHP, setGoblinFormColor }) {
  ...
  return (
    <div className='goblin-form-container quarter'>
      ...
      <form className='goblin-form' onSubmit={e => submitGoblin(e)}>
        <label>
            Name
